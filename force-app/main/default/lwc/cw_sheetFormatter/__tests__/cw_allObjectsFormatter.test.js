...
describe('all-objects-formatter', () => {
    ...
    it('format - given allobjects calls AllObjectsFormatter.format', () => {
        ...
        // Assert
        expect(body.requests.length).toBe(13);

		expect(body.requests[0].addSheet).toBeDefined();
		expect(body.requests[0].addSheet.properties.sheetId).toBe(333);
		...
		expect(body.requests[0].addSheet.properties.gridProperties.columnCount).toBe(10);

		expect(body.requests[1].mergeCells).toBeDefined();
		expect(body.requests[1].mergeCells.range.sheetId).toBe(333);
		...
		expect(body.requests[2].updateSheetProperties.properties.sheetId).toBe(333);
		expect(body.requests[2].updateSheetProperties.properties.gridProperties.columnCount).toBe(9);

		expect(body.requests[3].updateCells).toBeDefined();
		expect(body.requests[3].updateCells.fields).toBe('*');
		expect(body.requests[3].updateCells.start.sheetId).toBe(333);
		...
		expect(body.requests[3].updateCells.rows[0].values.length).toBe(9);
		expect(body.requests[3].updateCells.rows[1].values[0].userEnteredValue.stringValue).toBe('Object Label');
		...
		expect(body.requests[3].updateCells.rows[2].values[0].userEnteredValue.stringValue).toBe('Account');
		
		expect(body.requests[4].updateDimensionProperties).toBeDefined();
		expect(body.requests[4].updateDimensionProperties.range.sheetId).toBe(333);
		expect(body.requests[4].updateDimensionProperties.range.dimension).toBe('COLUMNS');
		expect(body.requests[4].updateDimensionProperties.range.startIndex).toBe(0);
		expect(body.requests[4].updateDimensionProperties.range.endIndex).toBe(1);
		expect(body.requests[4].updateDimensionProperties.fields).toBe('pixelSize');
		expect(body.requests[4].updateDimensionProperties.properties.pixelSize).toBe(250);
		expect(body.requests[5].updateDimensionProperties.properties.pixelSize).toBe(250);
		expect(body.requests[6].updateDimensionProperties.properties.pixelSize).toBe(150);
		expect(body.requests[7].updateDimensionProperties.properties.pixelSize).toBe(75);
		expect(body.requests[8].updateDimensionProperties.properties.pixelSize).toBe(75);
		...
		expect(body.requests[11].updateDimensionProperties.properties.pixelSize).toBe(300);
		expect(body.requests[12].updateDimensionProperties.properties.pixelSize).toBe(125);
    });
});